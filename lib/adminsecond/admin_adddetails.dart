  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Icon(Icons.person_add_alt_1,color: Colors.black,),
        centerTitle: true,
      ),
      body: SafeArea(
        child: Container(
              ...
              DropdownButton<String>(
                ...
                ElevatedButton(onPressed: (){
                  ...
                  nameController.value.text == '' ||
                    ...
                    Get.snackbar("Login","uploaded",backgroundColor: Colors.grey.withOpacity(0.5));
                    print("${jobtypeValue}");
                    _dbref.child("${serviceNameController.value.text}").child("logo").set(
                        "${imageUrl}");
                    _dbref
                        .child("${serviceNameController.value.text}")
                        .child("data")
